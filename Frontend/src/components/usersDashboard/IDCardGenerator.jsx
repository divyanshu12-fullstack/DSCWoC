    ...
    <>
      ...
      <div className="fixed inset-0 z-50 overflow-y-auto">
        <div className="flex min-h-[100dvh] items-center justify-center px-4 py-6">
          <div className="bg-gradient-to-br from-space-black via-midnight-blue to-space-black border border-cyan-500/30 rounded-2xl shadow-2xl shadow-cyan-500/20 w-full max-w-md animate-scaleIn overflow-hidden max-h-[calc(100vh-4rem)]">
      ...
      {showPreview && (
        <div
          className="fixed inset-0 z-50 overflow-y-auto px-4 py-6 bg-black/80 backdrop-blur-sm"
          onClick={handleClosePreview}
        >
          <div className="flex min-h-[100dvh] items-center justify-center">
            <div
              className="relative max-w-2xl w-full bg-gradient-to-br from-space-black via-midnight-blue to-space-black border border-cyan-500/30 rounded-2xl shadow-2xl shadow-cyan-500/20 overflow-hidden flex flex-col max-h-[calc(100vh-4rem)]"
