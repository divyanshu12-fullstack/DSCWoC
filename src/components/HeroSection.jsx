...
const HeroSection = () => {
  ...
  return (
    <section id="home" className="relative min-h-screen flex items-center justify-center px-4 sm:px-6 pt-32 pb-12 md:pt-0 overflow-hidden">
      
      {/* RESPONSIVE GRID LAYOUT: Mobile Stack / Desktop Side-by-Side */}
      <div className="max-w-7xl mx-auto grid grid-cols-1 md:grid-cols-2 gap-12 md:gap-8 items-center w-full">
        
        {/* Left: Text Content (Order 1) */}
        <div className="space-y-6 animate-fade-in text-center md:text-left relative z-10 order-1">
          <h1 className="text-4xl sm:text-5xl md:text-6xl lg:text-7xl font-bold text-white leading-tight">
            DSC WINTER <br className="hidden md:block" /> OF CODE
          </h1>
          <p className="text-xl sm:text-2xl md:text-3xl font-light nebula-text text-stellar-cyan tracking-wide">
          ...
          <div className="flex flex-col sm:flex-row gap-4 pt-6 justify-center md:justify-start">
            ...
            <Link 
              to="/submit-project" 
              className="retro-button border-2 border-cosmic-purple text-cosmic-purple hover:bg-cosmic-purple/20 px-8 py-3 rounded-full text-base font-semibold transition-all duration-300 hover:-translate-y-1 flex items-center justify-center gap-2 hover:shadow-lg hover:shadow-cosmic-purple/30"
            >
              <span>🛰️</span>
              BECOME A MENTOR
            </Link>
        ...
        {/* Right: 3D Astronaut Coding (Order 2) */}
        <div className="relative flex items-center justify-center mt-2 md:mt-0 order-2" style={{ perspective: '2000px' }}>
          <div 
            ref={spaceshipRef}
          ...
          >
            ...
            <div className="absolute top-1/2 left-0 -translate-y-1/2 w-full h-3 bg-gradient-to-r from-transparent via-nebula-pink/60 to-transparent blur-md animate-pulse -z-10"></div>
            <div className="absolute top-1/2 left-0 -translate-y-1/2 w-full h-1 bg-gradient-to-r from-transparent via-cosmic-purple/80 to-transparent -z-10"></div>
          </div>
        </div>
      </div>
    </section>
