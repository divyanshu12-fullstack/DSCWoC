...
const BenefitsSection = () => {
  ...
  return (
    // FIXED: Changed id from 'rewards' to 'benefits' to match Navbar link
    <section id="benefits" className="relative py-32 px-6 overflow-hidden">
      
      {/* ADDED: Central Cosmic Glow for better visual alignment with background */}
      <div className="absolute top-1/2 left-1/2 -translate-x-1/2 -translate-y-1/2 w-[800px] h-[800px] bg-cosmic-purple/10 rounded-full blur-[120px] -z-10 pointer-events-none"></div>

      {/* Animated background stars (Preserved) */}
